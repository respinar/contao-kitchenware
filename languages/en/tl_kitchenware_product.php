 ...
 * Fields
 */
$GLOBALS['TL_LANG']['tl_kitchenware_product']['title']       = array('Product title', 'Please enter the product title.');
...
$GLOBALS['TL_LANG']['tl_kitchenware_product']['irifdo']      = array('IRIFDO', 'Iran Food and Drug Organisation');
...
$GLOBALS['TL_LANG']['tl_kitchenware_product']['meta_description'] = array('Description meta tag', 'Please enter description meta tag for SEO.');
$GLOBALS['TL_LANG']['tl_kitchenware_product']['published']   = array('Publish product', 'Make the product item publicly visible on the website.');
$GLOBALS['TL_LANG']['tl_kitchenware_product']['featured']    = array('Feature product', 'Show the product item in a featured product list.');
$GLOBALS['TL_LANG']['tl_kitchenware_product']['start']       = array('Show from', 'Show the product item in a featured product list.');
$GLOBALS['TL_LANG']['tl_kitchenware_product']['stop']        = array('Show until', 'Show the product item in a featured product list.');
$GLOBALS['TL_LANG']['tl_kitchenware_product']['languageMain']= array('Master product', 'Choose the product in the master category equaling this product.');
...
$GLOBALS['TL_LANG']['tl_kitchenware_product']['meta_legend']        = 'Meta Tags';
...
$GLOBALS['TL_LANG']['tl_kitchenware_product']['pieces']     = array('Edit Product pieces', 'Edit pieces of product ID %s');
 ...
 * References
 */
$GLOBALS['TL_LANG']['tl_kitchenware_product']['sameDay']	= 'Same day';
$GLOBALS['TL_LANG']['tl_kitchenware_product']['otherDay']	= 'Other days';
